...
.provider('angularPrerender', function() {
    ...
    function createRoutes(params) {
      ...
      if (!isHashRoute()) {
        ...
        var route = _.find(window.prerenderConfig.routes, function(route) { return route.name === urlRoute || route.name+'.html' === urlRoute; });
